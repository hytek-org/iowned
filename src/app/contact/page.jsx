      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 mx-4 md:mx-16 max-w-[570px] lg:mb-0">
          ...
          <p className="text-body-color mb-9 text-base leading-relaxed dark:text-gray-300">
           If you have any questions, comments, or feedback, please feel free to contact us using this form . We will get back to you as soon as possible. Thank you for choosing iowned.net as your online platform.😊
          </p>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            ...
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
              We hate spam as much as you do. That’s why we only send you relevant and useful information that you can benefit from. You can always opt out of our emails if you change your mind. We value your trust and loyalty
              </dd>
            </div>
          </dl>
        </div>
