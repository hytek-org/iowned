...
const loading = () => {
  return (
   ...
   <section>
<div role="status" className="px-2 py-2 md:py-5 md:px-10 space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
...
<div role="status" className="space-y-2.5 animate-pulse px-5 py-5 mb-10 ">
